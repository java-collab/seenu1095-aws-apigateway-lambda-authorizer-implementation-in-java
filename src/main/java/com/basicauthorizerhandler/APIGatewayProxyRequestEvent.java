...
public class APIGatewayProxyRequestEvent implements Serializable, Cloneable {
    ...
    /**
     * @return The methodArn defined in API Gateway
     */
    public String getMethodArn() {
		return methodArn;
	}
    /**
     * @param resource The methodArn defined in API Gateway
     */
    ...
    public String toString() {
        ...
        if (getPath() != null)
            sb.append("path: ").append(getPath()).append(",");
        if (getMethodArn() != null)
            sb.append("methodArn: ").append(getMethodArn()).append(",");
        if (getHttpMethod() != null)
            sb.append("httpMethod: ").append(getHttpMethod()).append(",");
        if (getHeaders() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPath() != null && other.getPath().equals(this.getPath()) == false)
            return false;
        if (other.getMethodArn() == null ^ this.getMethodArn() == null)
            return false;
        if (other.getMethodArn() != null && other.getMethodArn().equals(this.getMethodArn()) == false)
            return false;
        if (other.getHttpMethod() == null ^ this.getHttpMethod() == null)
            return false;
        if (other.getHttpMethod() != null && other.getHttpMethod().equals(this.getHttpMethod()) == false)
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getPath() == null) ? 0 : getPath().hashCode());
        hashCode = prime * hashCode + ((getMethodArn() == null) ? 0 : getMethodArn().hashCode());
        hashCode = prime * hashCode + ((getHttpMethod() == null) ? 0 : getHttpMethod().hashCode());
